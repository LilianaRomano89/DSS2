...
/**
 * Service definition for Dss (v1.3).
 *
 * <p>
...
public class Dss extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "dss/v1.3/";
  /**
  ...
  public class NotificationApi {
     ...
     *
     * @param content the {@link com.appspot.domoticsmartsystem.dss.model.NotificationMessageUnregister}
     * @return the request
     */
    public Unregister unregister(com.appspot.domoticsmartsystem.dss.model.NotificationMessageUnregister content) throws java.io.IOException {
    ...
    public class Unregister extends DssRequest<com.appspot.domoticsmartsystem.dss.model.GenericMessagesResponse> {
       ...
       * @since 1.13
       */
      protected Unregister(com.appspot.domoticsmartsystem.dss.model.NotificationMessageUnregister content) {
        super(Dss.this, "POST", REST_PATH, content, com.appspot.domoticsmartsystem.dss.model.GenericMessagesResponse.class);
      }
  ...
  public class SensorApi {
     ...
     * @return the request
     */
    public SensorState sensorState(java.lang.String token) throws java.io.IOException {
      SensorState result = new SensorState(token);
      initialize(result);
      return result;
    }
    ...
    public class SensorState extends DssRequest<com.appspot.domoticsmartsystem.dss.model.SensorMessageStateResponse> {
       ...
       * @since 1.13
       */
      protected SensorState(java.lang.String token) {
      ...
      public SensorState setToken(java.lang.String token) {
        this.token = token;
        return this;
      }
  ...
  public class UserApi {
     ...
     * @return the request
     */
    public ValidateUser validateUser(java.lang.String token) throws java.io.IOException {
      ValidateUser result = new ValidateUser(token);
      initialize(result);
      return result;
    }
    ...
    public class ValidateUser extends DssRequest<com.appspot.domoticsmartsystem.dss.model.GenericMessagesResponse> {
       ...
       * @since 1.13
       */
      protected ValidateUser(java.lang.String token) {
        super(Dss.this, "GET", REST_PATH, null, com.appspot.domoticsmartsystem.dss.model.GenericMessagesResponse.class);
        this.token = com.google.api.client.util.Preconditions.checkNotNull(token, "Required parameter token must be specified.");
      }
      ...
      public ValidateUser setToken(java.lang.String token) {
        this.token = token;
        return this;
      }
